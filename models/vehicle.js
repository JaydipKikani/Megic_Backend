...
const generalInfoSchema = new mongoose.Schema({
    main_fuel: { type: mongoose.Schema.Types.ObjectId, ref: 'FuelType', required: true },
...
const DamageMaintenance = mongoose.model('DamageMaintenance', damageMaintenanceSchema);
